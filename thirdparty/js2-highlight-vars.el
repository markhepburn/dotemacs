...
(deflocal js2-highlight-vars-mode nil)
...
(deflocal js2--highlight-vars-tokens nil)
(deflocal js2--highlight-vars-current-token nil)
(deflocal js2--highlight-vars-current-token-name nil)
(deflocal js2--highlight-vars-post-command-timer nil)
